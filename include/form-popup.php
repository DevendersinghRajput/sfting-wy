...
<div class="terigerd-box" id="myPopup">
        ...
        <form action="include/mail" class="form-trigerd r-flex ali-c jut-sb flex-w" >
            ...
            <input class="form-pop-input" required="required" type="number" id="PhoneNumber" name="PhoneNumber" placeholder="Enter mobile no..." pattern="^[6789]\d{9}$" autocomplete="off">
            <button type="submit" class="form-triged-pop-btn">Know Price</button>
            <a href="tel:+91 8222061512" class="form-call-btn r-flex ali-c jut-sb"  >
