...
<div class="terigerd-box" id="myPopup">
        ...
        <form action="include/mail" class="form-trigerd r-flex ali-c jut-sb flex-w" >
            ...
            <button type="submit" onclick="gtag('event', 'submit_btn_click');" class="form-triged-pop-btn">Free Quotation</button>
            <a href="tel:8684809875" class="form-call-btn r-flex ali-c jut-sb" onclick="gtag('event', 'pop_call_btn');" >
